		...
		<div class="complaint-container">
			...
			<div class="right-panel">
				...
				<form class="complaint-form" action="/submitComplaint" method="post"
					...
					<!-- Department Hidden -->
					<input type="hidden" name="dept" id="deptField">
					...
					<div class="input-box">
						<label>Complaint Location</label> <input type="text"
					...
					<div class="input-box">
						...
						<textarea name="description"
							placeholder="Write complaint details..." required></textarea>
					</div>
					...
					<div class="input-box">
						...
						<div class="upload-area"
							...
							<input type="file" name="image" id="imageUpload" accept="image/*"
								capture="environment" hidden required> <img
								id="previewImg" class="preview-img" alt="Preview">
						</div>
					</div>
